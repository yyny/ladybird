...
public:
    ...
    AK_MAKE_CONDITIONALLY_DESTRUCTIBLE(OptionalBase, <T>);

    ALWAYS_INLINE ~OptionalBase()
    ...
    {
        return static_cast<Self const*>(this)->has_value() ? __builtin_launder(reinterpret_cast<T*>(&static_cast<Self const*>(this)->value())) : nullptr;
    }
